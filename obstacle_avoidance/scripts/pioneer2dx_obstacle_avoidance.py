...
def callback2(odom):
    ...
    X.append(pos_new[0])
    Y.append(pos_new[1])
    np.save('/home/nedim/Desktop/Gazebo_files/Sim_4/Met_2/X_odom', X)
    np.save('/home/nedim/Desktop/Gazebo_files/Sim_4/Met_2/Y_odom', Y)
...
if __name__ == "__main__":
    ...
    detector = cv2.xfeatures2d.SURF_create(hessianThreshold = 200, nOctaves = 3, nOctaveLayers = 3) #200 
    linear_vel = 0.2
    angular_vel = 0.3
    flag = 0
    counter = 0
